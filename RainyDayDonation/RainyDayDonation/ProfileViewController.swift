...
class ProfileViewController: UIViewController, NSFetchedResultsControllerDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.projectName.text = "Visually Appealing"
        ...
        cell.projectURL.text = "https://www.donorschoose.org/project/visually-appealing/2232977/"
        ...
        dump(fetechedResultsController.fetchedObjects)
        return cell
    }
